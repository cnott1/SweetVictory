...
#CHECK THE PART3VOCAL (LINE 563) FUNCTION FOR ARRAY USAGE
#CHECK END OF CODE FOR CONDITIONAL
#IF THE CODE DELETES ON RUNTIME, 1. RELOAD FILE (DONT HIT PLAY) 2. COPY AND PASTE ALL CODE OVER ITSELF 3. IT SHOULD WORK
...
loop do
  ...
  sleep sample_duration s_wilhelm
end